...
# Using Redis backend for better memory efficiency
...
limiter = Limiter(
    ...
    storage_uri="memory://",  # Using memory backend with optimized settings
    strategy="moving-window",  # More efficient than fixed window
    default_limits=["100 per day", "20 per hour"]  # More conservative limits
)
